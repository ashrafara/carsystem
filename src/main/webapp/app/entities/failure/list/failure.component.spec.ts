...
describe('Failure Management Component', () => {
  let comp: FailureComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(FailureComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.failures?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
